...
SX update(const SX& x, const SX& u, const SX& d, const SX& p) {
    ...
    // Equation 47 [1]
    a[175] = 2.0 * p(111) * p(23) * a[31] / (p(1) * p(14) * (p(41) + a[174]));
    ...
    a[196] = (1. / (2. * p(136))) * (a[195] + p(137) * a[191] -
        sqrt(pow((a[195] + p(137) * a[191]), 2) - 4*p(136) * a[195] * p(137) * a[191] + 1e-6));
