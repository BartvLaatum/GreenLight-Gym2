...
SX ODE_pipe(const SX& x, const SX& u, const SX& d, const SX& p)
{
    // Compute the auxiliary variables
    SX a = update(x, u, d, p);
    SX dxdt = SX::zeros(x.size());
   ...
   // Canopy temperature [°C s^{-1}]
    ...
    SX tPipeOn = d(10) - x(9);
    SX tPipeOff = 1./p(110) * (a(220) + a(231) + a(232) - a(89)-\
        a(88) - a(92) - a(91) - a(90) - a(157)+\
        + a(100) - a(107) + a(238) + a(116));

    dxdt(9) = if_else((d(10) < 1) || (d(12) > 0), tPipeOff, tPipeOn);
    ...
    SX tGoPipeOn = d(11) - x(19);
    SX tGoPipeOff = 1./p(171) * (a(221) - a(105) - a(166));
    // dxdt(19) = if_else((d(11) < 1) || (d(13) > 0.01), tGoPipeOff, tGoPipeOn);
    dxdt(19) = 0;
