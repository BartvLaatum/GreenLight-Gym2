...
# Load the data
states_pipe = pd.read_csv("data/bleiswijk/states_pipeinput.csv")
led_data = pd.read_csv("data/bleiswijk/gl_gym_states.csv")
...
fig.savefig("data/bleiswijk/states_pipeinput_led_comparison.png")

# Load control data
controls_pipe = pd.read_csv("data/bleiswijk/controls_pipeinput.csv").iloc[:states_pipe.shape[0]]
glgym_controls = pd.read_csv("data/bleiswijk/gl_gym_states.csv")

pipe_weather = pd.read_csv("data/bleiswijk/weather_pipeinput.csv").values[:,:10]
gl_gym_weather = pd.read_csv("data/bleiswijk/gl_gym_weather.csv").values[:,:10]
...
for i, col in enumerate(controls_pipe.columns[:]):
    ...
    ax.grid(True)
fig2.tight_layout()
fig2.savefig("data/bleiswijk/controls_comparison.png")
...
fig3.tight_layout()
fig3.savefig("data/bleiswijk/weather_comparison.png")
